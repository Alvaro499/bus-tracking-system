...
import com.bustracking.tracking.infrastructure.web.controller.TrackingTripController;

@WebMvcTest(TrackingTripController.class)
class TrackingTripControllerTest extends ControllerIntegrationTest {
